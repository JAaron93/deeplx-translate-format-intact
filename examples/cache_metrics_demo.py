...
async def demonstrate_metrics():
    ...
    print("   Initial cache stats:", _metrics_collector.get_cache_stats())
    ...
    print(
        ...
        _metrics_collector.get_cache_stats()
    )
    print(
        f"   Cache hit rate: {_metrics_collector.get_cache_hit_rate():.2%}"
    )
    ...
    print(
        "   Cache hit rate:", 
        f"{_metrics_collector.get_cache_hit_rate():.2%}"
    )
    print(
        "   Active connections:", 
        _metrics_collector.get_active_connections()
    )
    print("   Cache stats:", _metrics_collector.get_cache_stats())
