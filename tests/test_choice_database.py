...
from models.user_choice_models import (
    UserChoice, ChoiceSession, ChoiceConflict, TranslationContext,
...
class TestChoiceDatabase:
    ...
    def test_database_initialization(self, temp_db):
        ...
        with temp_db._get_connection() as conn:
            ...
            expected_tables = [
                'user_choices', 'choice_sessions', 'choice_conflicts',
                'choice_contexts', 'translation_preferences', 'database_metadata'
            ]
    ...
    def test_save_and_get_user_choice(self, temp_db, sample_choice):
        ...
        assert retrieved_choice.context.semantic_field == sample_choice.context.semantic_field
        assert retrieved_choice.context.philosophical_domain == sample_choice.context.philosophical_domain
