...
class LanguageDetector:
    ...
    def _simple_language_detection(self, text: str) -> str:
        ...
        language_patterns = {
            'German': {
                'words': ['der', 'die', 'das', 'und', 'ist', 'ein', 'eine', 'mit', 'von', 'zu'],
                'chars': ['ä', 'ö', 'ü', 'ß'],
                'word_weight': 1.0,
                'char_weight': 2.0
            },
            'English': {
                'words': ['the', 'and', 'is', 'a', 'an', 'with', 'of', 'to', 'in', 'for'],
                'chars': [],
                'word_weight': 1.0,
                'char_weight': 0.0
            },
            'Spanish': {
                'words': ['el', 'la', 'y', 'es', 'un', 'una', 'con', 'de', 'en', 'para'],
                'chars': ['ñ', 'á', 'é', 'í', 'ó', 'ú'],
                'word_weight': 1.0,
                'char_weight': 2.0
            },
            'French': {
                'words': ['le', 'la', 'et', 'est', 'un', 'une', 'avec', 'de', 'en', 'pour'],
                'chars': ['à', 'é', 'è', 'ê', 'ç', 'ô'],
                'word_weight': 1.0,
                'char_weight': 2.0
            }
